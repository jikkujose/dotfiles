...
alias gc="git commit "
alias gdev="geth --mine --minerthreads 1 --rpc --rpcport 8100 --unlock 0 --dev --datadir '~/Ethereum/test_datadir'"
alias gdev_console="geth --dev --datadir '~/Ethereum/test_datadir' --jspath '/Users/jikkujose/Ethereum/scripts' attach"
