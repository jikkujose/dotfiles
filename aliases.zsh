...
alias gc="git commit "
alias geth_dev="geth --dev --datadir $ETHEREUM_DEV"
alias geth_dev-console="geth --jspath $HOME/Ethereum/scripts attach ipc:$ETHEREUM_DEV/geth.ipc"
alias geth_forked="geth --support-dao-fork --cache=2048 --datadir $ETHEREUM_FORKED"
alias geth_forked-console="geth --jspath $HOME/Ethereum/scripts attach ipc:$ETHEREUM_FORKED/geth.ipc"
alias geth_classic="geth --oppose-dao-fork --cache=2048 --datadir $ETHEREUM_CLASSIC"
alias geth_classic-console="geth --jspath $HOME/Ethereum/scripts attach ipc:$ETHEREUM_CLASSIC/geth.ipc"
