...
alias geth_forked="geth --support-dao-fork --cache=2048 --datadir $ETHEREUM_FORKED --light"
alias geth_classic="geth --oppose-dao-fork --cache=2048 --datadir $ETHEREUM_CLASSIC --light"
