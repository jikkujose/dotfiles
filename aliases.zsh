...
alias geth_forked-console="geth --datadir $ETHEREUM_FORKED --jspath $HOME/Ethereum/scripts/ attach"
alias geth_classic="geth --oppose-dao-fork --cache=2048 --datadir $ETHEREUM_CLASSIC"
alias geth_classic-console="geth --datadir $ETHEREUM_CLASSIC --jspath $HOME/Ethereum/scripts/ attach"
