...
alias nn="nvim"
alias p="powershell.exe -c Get-Clipboard -Raw"
...
alias tt="tree -NC -I 'node_modules|dist'"
alias uf="p | c"
...
alias vik="ruby ~/Projects/vik/app.rb"
alias clear-metatadata="exiftool -overwrite_original -all="
