...
alias gc="git commit "
alias geth_dev="geth --dev --datadir '~/Ethereum/test_datadir'"
alias geth_dev-console="geth --dev --datadir '~/Ethereum/test_datadir' attach"
alias geth_forked="geth --support-dao-fork --cache=2048 --datadir $ETHEREUM_FORKED"
alias geth_forked-console="geth attach --datadir $ETHEREUM_FORKED"
alias geth_classic="geth --oppose-dao-fork --cache=2048 --datadir $ETHEREUM_CLASSIC"
alias geth_classic-console="geth --datadir $ETHEREUM_CLASSIC attach"
